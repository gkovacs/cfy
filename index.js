...
(function(){
  var co, unthenify, add_noerr, yfy, yfy_node, yfy_multi, yfy_multi_node, cfy, cfy_varargs, cfy_node, cfy_varargs_node, make_callable, out$ = typeof exports != 'undefined' && exports || this, slice$ = [].slice;
  co = require('co');
  ...
  make_callable = function(obj, func){
